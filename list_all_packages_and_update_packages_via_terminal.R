...
sudo su - -c "R -e \"pkgs <- c('officer', 'Rdpack', 'RSQLite'); sapply(pkgs, install.packages, repos='https://cran.rstudio.org', lib='/usr/lib/R/library', dependencies = TRUE, INSTALL_opts = '--no-lock')\""
