...
sudo su - -c "R -e \"pkgs <- c('miniUI', 'crayon'); sapply(pkgs, install.packages, repos='https://cran.rstudio.org', lib='/usr/lib/R/library', dependencies = TRUE, INSTALL_opts = '--no-lock')\""
