...
Aug-2016 to - Present
:  [**Master of Computer Science in Data Science**](http://cs.illinois.edu/);
[Cousera](http://www.coursera.org) - [University of Illinois at Urbana–Champaign](http://illinois.edu/)
  
  - *Completed registration on May-2016, awaiting for orientation*

Sep-2016 to - Present
:  [**Bachelor of Science in Computer Science**](http://www.uopeople.edu/programs/bachelor-of-science-computer-science/);
...
: **Customer Service Executive**; [Manpower Human Resource Sdn Bhd](http://www.manpower.com.my/)
  ...
  - *Salary             : MYR4000*
  - *Job Task           : Under training...*
  - *Remarks            : An outsourcing HR company pay salary but work for [Mindpearl](https://www.mindpearl.com/) and training at [Malaysian Airline](http://www.malaysiaairlines.com/my/en.html) as time being...*
...
: **Online Gambling, Trainer/Trader**; [Caspo Inc.](http://www.callcenterbeat.com/caspo-philippines/)
  ...
  - *Salary             : MYR`r 5000 + 220 * read_html('http://www.bloomberg.com/quote/USDMYR:CUR') %>% html_nodes(xpath = '//*[@id="content"]/div/div/div[1]/div/div[4]/div[2]') %>% html_text %>% as.numeric` + 3~99months Annual Bonus (SGDxxxxxx)*
...
### 7. Other/Miscellaneous
  ...
  I wrote an article to share about [安装 ®StudioとShiny服务器](https://github.com/Scibrokes/setup-rstudio-server) <img src='figure/rstudio.jpg' width='24'> and currently registered for studying at [Master of Computer Science in Data Science](http://cs.illinois.edu/prospective-students/graduate-students/mcs-ds-apply-now) and [Bachelor of Science in Computer Science](http://www.uopeople.edu/programs/bachelor-of-science-computer-science/). You are welcome to own yours by refer to my [Personal WP Blog](https://englianhu.wordpress.com) (will be migrated to Jekyll/Hugo some other days). You are welcome to contact me at <englianhu@gmail.com>.
