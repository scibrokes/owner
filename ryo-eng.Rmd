...
*graph 4.3.1 : Sample data GitHub-Pages Blog.*
...
*slides 4.4.1 : 为数据科学家们量身定做の专业统计软件 — ®Studio服务器*
...
*table 4.5.1 : Breakdown of Operators - Profit & Loss on the Odds Price with/without Overrounds.*
...
*website 4.6.1 : Dixon-Coles 1996*
