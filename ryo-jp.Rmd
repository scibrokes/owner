...
| 宗教                                  |                                                                          [卍 <ruby>仏<rp>(</rp><rt>ぶっ</rt><rp>)</rp>家<rp>(</rp><rt>け</rt><rp>)</rp></ruby>]{style="color:RoyalBlue"}[^11] |
| 種族                                  |                                                                                                                                                                             🇹🇼🇨🇳 中華民族 |
...
| 其它語言                              |               🇭🇰 粵語 / 🇬🇧🇺🇸 英語 / 🇯🇵 日本語 / 🇮🇩🇲🇾 印尼語-馬來語 / <s>🇰🇷 韓國語</s> / <s>🇩🇪 ドイツ語</s> / <s>🇫🇷 法語</s> / <s>🇵🇭 タガログ語</s> / <s>🇰🇭 高棉語</s> |
...
```{r read-geodata, error = TRUE, echo = FALSE, warning = FALSE, error = TRUE, results = 'asis'}
...
```{r plot-map, error = TRUE, echo = FALSE, warning = FALSE, error = TRUE, results = 'asis'}
