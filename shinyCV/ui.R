...
ui <- shinyUI(
  ...
  dashboardSidebar(
    sidebarMenu(id = "tabs", 
      menuItem("Home", tabName = "menu", 
               ...
               menuSubItem("English", tabName = "eng"), 
               menuSubItem("Simplified Chinese", tabName = "chn"), 
               menuSubItem("Traditional Chinese", tabName = "twn"),
               menuSubItem("Japanese", tabName = "jpn")),
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = 'eng', h2('English'), uiOutput('ryo_en')), 
      tabItem(tabName = 'chn', h2('Chinese (Simplified)'), uiOutput('ryo_cn')), 
      tabItem(tabName = 'twn', h2('Chinese (Traditional)'), uiOutput('ryo_tw')), 
      tabItem(tabName = 'jpn', h2('Japanese'), uiOutput('ryo_jp')), 
