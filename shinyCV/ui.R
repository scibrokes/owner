  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = 'en', h2('English'), 
              tags$iframe(src = 'https://beta.rstudioconnect.com/content/4356/ryo-en.html', 
                          height = 800, width = '100%', frameborder = 0)), 
      tabItem(tabName = 'cn', h2('Chinese (Simplified)'), 
              tags$iframe(src = 'https://beta.rstudioconnect.com/content/4355/ryo-cn.html', 
                          height = 800, width = '100%', frameborder = 0)), 
      tabItem(tabName = 'tw', h2('Chinese (Traditional)'), 
              tags$iframe(src = 'https://beta.rstudioconnect.com/content/4357/ryo-tw.html', 
                          height = 800, width = '100%', frameborder = 0)), 
      tabItem(tabName = 'jp', h2('Japanese'), 
              tags$iframe(src = 'https://beta.rstudioconnect.com/content/4358/ryo-jp.html', 
                          height = 800, width = '100%', frameborder = 0)), 
      tabItem(tabName = 'author', h2('Author'), 
              tags$iframe(src = 'https://beta.rstudioconnect.com/content/4354/ryo-eng.html', 
                          height = 800, width = '100%', frameborder = 0))), 
    br(), 
