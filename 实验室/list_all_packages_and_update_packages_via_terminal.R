...
sudo apt install -y l*gsl* libcatalyst-action-rest-perl libghc-hmatrix-doc libghc-storable-complex-doc libghc-hmatrix-doc libcatalyst-action-serialize-data-serializer-perl
...
sudo su - -c "R -e \"install.packages(c('languageserver'), lib='/usr/lib/R/library', dependencies = c('Depends', 'Imports'), INSTALL_opts = '--no-lock')\""
